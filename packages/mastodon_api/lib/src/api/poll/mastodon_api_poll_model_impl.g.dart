...
class MastodonApiPollAdapter extends TypeAdapter<MastodonApiPoll> {
  @override
  final int typeId = 0;

  @override
  MastodonApiPoll read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return MastodonApiPoll(
      expired: fields[0] as bool,
      expiresAt: fields[1] as DateTime?,
      id: fields[2] as String?,
      multiple: fields[3] as bool,
      options: (fields[4] as List).cast<MastodonApiPollOption>(),
  ...
  @override
  void write(BinaryWriter writer, MastodonApiPoll obj) {
    writer
      ..writeByte(9)
      ..writeByte(2)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is MastodonApiPollAdapter &&
