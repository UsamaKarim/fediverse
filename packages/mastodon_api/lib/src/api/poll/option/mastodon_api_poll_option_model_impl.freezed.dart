...
abstract class $MastodonApiPollOptionCopyWith<$Res> {
  factory $MastodonApiPollOptionCopyWith(MastodonApiPollOption value,
      ...
      _$MastodonApiPollOptionCopyWithImpl<$Res, MastodonApiPollOption>;
  @useResult
  $Res call(
...
class _$MastodonApiPollOptionCopyWithImpl<$Res,
        $Val extends MastodonApiPollOption>
...
/// @nodoc
abstract class _$$MastodonApiPollOptionImplCopyWith<$Res>
    implements $MastodonApiPollOptionCopyWith<$Res> {
  factory _$$MastodonApiPollOptionImplCopyWith(
          _$MastodonApiPollOptionImpl value,
          $Res Function(_$MastodonApiPollOptionImpl) then) =
      __$$MastodonApiPollOptionImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@HiveField(0) String title,
...
/// @nodoc
class __$$MastodonApiPollOptionImplCopyWithImpl<$Res>
    extends _$MastodonApiPollOptionCopyWithImpl<$Res,
        _$MastodonApiPollOptionImpl>
    implements _$$MastodonApiPollOptionImplCopyWith<$Res> {
  __$$MastodonApiPollOptionImplCopyWithImpl(_$MastodonApiPollOptionImpl _value,
      $Res Function(_$MastodonApiPollOptionImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$MastodonApiPollOptionImpl(
      title: null == title
          ? _value.title
          : title // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$MastodonApiPollOptionImpl implements _MastodonApiPollOption {
  const _$MastodonApiPollOptionImpl(
      {@HiveField(0) required this.title,
      @HiveField(1) @JsonKey(name: 'votes_count') required this.votesCount});

  factory _$MastodonApiPollOptionImpl.fromJson(Map<String, dynamic> json) =>
      _$$MastodonApiPollOptionImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MastodonApiPollOptionImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MastodonApiPollOptionImplCopyWith<_$MastodonApiPollOptionImpl>
      get copyWith => __$$MastodonApiPollOptionImplCopyWithImpl<
          _$MastodonApiPollOptionImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MastodonApiPollOptionImplToJson(
      this,
    );
  }
}
...
abstract class _MastodonApiPollOption implements MastodonApiPollOption {
  const factory _MastodonApiPollOption(
      ...
      @HiveField(1)
      @JsonKey(name: 'votes_count')
      required final int? votesCount}) = _$MastodonApiPollOptionImpl;

  factory _MastodonApiPollOption.fromJson(Map<String, dynamic> json) =
      _$MastodonApiPollOptionImpl.fromJson;
