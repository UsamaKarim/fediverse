...
class UnifediApiSchedulePostStatusAdapter
    extends TypeAdapter<UnifediApiSchedulePostStatus> {
  @override
  final int typeId = 0;

  @override
  UnifediApiSchedulePostStatus read(BinaryReader reader) {
    ...
    return UnifediApiSchedulePostStatus(
      ...
      poll: fields[7] as UnifediApiPostStatusPoll?,
  ...
  @override
  void write(BinaryWriter writer, UnifediApiSchedulePostStatus obj) {
    writer
      ..writeByte(14)
      ..writeByte(13)
  ...
  bool operator ==(Object other) =>
      ...
      other is UnifediApiSchedulePostStatusAdapter &&
