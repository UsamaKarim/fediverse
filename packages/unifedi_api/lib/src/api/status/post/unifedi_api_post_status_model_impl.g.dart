...
class UnifediApiPostStatusAdapter extends TypeAdapter<UnifediApiPostStatus> {
  @override
  final int typeId = 0;

  @override
  UnifediApiPostStatus read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, UnifediApiPostStatus obj) {
    writer
      ..writeByte(13)
      ..writeByte(2)
  ...
  bool operator ==(Object other) =>
      ...
      other is UnifediApiPostStatusAdapter &&
