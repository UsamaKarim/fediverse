...
part of 'unifedi_api_timeline_reply_visibility_filter_model.dart';
...
/// @nodoc
mixin _$UnifediApiReplyVisibilityFilter {
  ...
  @JsonKey(ignore: true)
  $UnifediApiReplyVisibilityFilterCopyWith<UnifediApiReplyVisibilityFilter>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UnifediApiReplyVisibilityFilterCopyWith<$Res> {
  factory $UnifediApiReplyVisibilityFilterCopyWith(
          UnifediApiReplyVisibilityFilter value,
          $Res Function(UnifediApiReplyVisibilityFilter) then) =
      _$UnifediApiReplyVisibilityFilterCopyWithImpl<$Res,
...
/// @nodoc
class _$UnifediApiReplyVisibilityFilterCopyWithImpl<$Res,
        $Val extends UnifediApiReplyVisibilityFilter>
    implements $UnifediApiReplyVisibilityFilterCopyWith<$Res> {
  _$UnifediApiReplyVisibilityFilterCopyWithImpl(this._value, this._then);
...
class __$$FollowingImplCopyWithImpl<$Res>
    extends _$UnifediApiReplyVisibilityFilterCopyWithImpl<$Res, _$FollowingImpl>
...
class _$FollowingImpl implements _Following {
  const _$FollowingImpl(
      {this.stringValue =
          UnifediApiReplyVisibilityFilter.followingStringValue});
  ...
  @override
  String toString() {
    return 'UnifediApiReplyVisibilityFilter.following(stringValue: $stringValue)';
  }
...
abstract class _Following implements UnifediApiReplyVisibilityFilter {
...
class __$$SelfImplCopyWithImpl<$Res>
    extends _$UnifediApiReplyVisibilityFilterCopyWithImpl<$Res, _$SelfImpl>
...
class _$SelfImpl implements _Self {
  const _$SelfImpl(
      {this.stringValue = UnifediApiReplyVisibilityFilter.selfStringValue});
  ...
  @override
  String toString() {
    return 'UnifediApiReplyVisibilityFilter.self(stringValue: $stringValue)';
  }
...
abstract class _Self implements UnifediApiReplyVisibilityFilter {
