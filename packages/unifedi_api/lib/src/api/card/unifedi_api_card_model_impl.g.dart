...
class UnifediApiCardAdapter extends TypeAdapter<UnifediApiCard> {
  @override
  final int typeId = 0;

  @override
  UnifediApiCard read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return UnifediApiCard(
  ...
  @override
  void write(BinaryWriter writer, UnifediApiCard obj) {
    writer
      ..writeByte(13)
      ..writeByte(12)
      ..write(obj.url)
  ...
  bool operator ==(Object other) =>
      ...
      other is UnifediApiCardAdapter &&
