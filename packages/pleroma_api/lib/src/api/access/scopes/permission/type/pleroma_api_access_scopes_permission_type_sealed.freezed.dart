...
part of 'pleroma_api_access_scopes_permission_type_sealed.dart';
...
/// @nodoc
mixin _$PleromaApiAccessScopesPermissionType {
  ...
  @JsonKey(ignore: true)
  $PleromaApiAccessScopesPermissionTypeCopyWith<
          PleromaApiAccessScopesPermissionType>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PleromaApiAccessScopesPermissionTypeCopyWith<$Res> {
  factory $PleromaApiAccessScopesPermissionTypeCopyWith(
          PleromaApiAccessScopesPermissionType value,
          $Res Function(PleromaApiAccessScopesPermissionType) then) =
      _$PleromaApiAccessScopesPermissionTypeCopyWithImpl<$Res,
          PleromaApiAccessScopesPermissionType>;
  @useResult
...
/// @nodoc
class _$PleromaApiAccessScopesPermissionTypeCopyWithImpl<$Res,
        $Val extends PleromaApiAccessScopesPermissionType>
    implements $PleromaApiAccessScopesPermissionTypeCopyWith<$Res> {
  _$PleromaApiAccessScopesPermissionTypeCopyWithImpl(this._value, this._then);
...
class __$$ReadImplCopyWithImpl<$Res>
    extends _$PleromaApiAccessScopesPermissionTypeCopyWithImpl<$Res, _$ReadImpl>
...
class _$ReadImpl implements _Read {
  const _$ReadImpl(
      {this.stringValue =
          PleromaApiAccessScopesPermissionType.readStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiAccessScopesPermissionType.read(stringValue: $stringValue)';
  }
...
abstract class _Read implements PleromaApiAccessScopesPermissionType {
...
class __$$WriteImplCopyWithImpl<$Res>
    extends _$PleromaApiAccessScopesPermissionTypeCopyWithImpl<$Res,
...
class _$WriteImpl implements _Write {
  const _$WriteImpl(
      {this.stringValue =
          PleromaApiAccessScopesPermissionType.writeStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiAccessScopesPermissionType.write(stringValue: $stringValue)';
  }
...
abstract class _Write implements PleromaApiAccessScopesPermissionType {
...
class _$ValidImpl implements _Valid {
  const _$ValidImpl(
      {this.stringValue =
          PleromaApiAccessScopesPermissionType.followStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiAccessScopesPermissionType.follow(stringValue: $stringValue)';
  }
...
abstract class _Valid implements PleromaApiAccessScopesPermissionType {
...
class __$$PushImplCopyWithImpl<$Res>
    extends _$PleromaApiAccessScopesPermissionTypeCopyWithImpl<$Res, _$PushImpl>
...
class _$PushImpl implements _Push {
  const _$PushImpl(
      {this.stringValue =
          PleromaApiAccessScopesPermissionType.pushStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiAccessScopesPermissionType.push(stringValue: $stringValue)';
  }
...
abstract class _Push implements PleromaApiAccessScopesPermissionType {
...
class _$AdminReadImpl implements _AdminRead {
  const _$AdminReadImpl(
      {this.stringValue =
          PleromaApiAccessScopesPermissionType.adminReadStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiAccessScopesPermissionType.adminRead(stringValue: $stringValue)';
  }
...
abstract class _AdminRead implements PleromaApiAccessScopesPermissionType {
...
class _$AdminWriteImpl implements _AdminWrite {
  ...
  @override
  String toString() {
    return 'PleromaApiAccessScopesPermissionType.adminWrite(stringValue: $stringValue)';
  }
...
abstract class _AdminWrite implements PleromaApiAccessScopesPermissionType {
