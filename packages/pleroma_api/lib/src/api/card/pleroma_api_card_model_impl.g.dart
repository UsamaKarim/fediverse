...
class PleromaApiCardAdapter extends TypeAdapter<PleromaApiCard> {
  @override
  final int typeId = 0;

  @override
  PleromaApiCard read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, PleromaApiCard obj) {
    writer
      ..writeByte(13)
      ..writeByte(12)
      ..write(obj.url)
  ...
  bool operator ==(Object other) =>
      ...
      other is PleromaApiCardAdapter &&
