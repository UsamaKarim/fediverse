...
class PleromaApiWebSocketsChannelAdapter
    extends TypeAdapter<PleromaApiWebSocketsChannel> {
  @override
  final int typeId = 0;

  @override
  PleromaApiWebSocketsChannel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return PleromaApiWebSocketsChannel(
  ...
  @override
  void write(BinaryWriter writer, PleromaApiWebSocketsChannel obj) {
    writer
      ..writeByte(10)
      ..writeByte(2)
  ...
  bool operator ==(Object other) =>
      ...
      other is PleromaApiWebSocketsChannelAdapter &&
