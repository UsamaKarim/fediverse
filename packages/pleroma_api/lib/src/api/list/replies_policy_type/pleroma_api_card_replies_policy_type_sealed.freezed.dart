...
part of 'pleroma_api_card_replies_policy_type_sealed.dart';
...
/// @nodoc
mixin _$PleromaApiListRepliesPolicyType {
  ...
  @JsonKey(ignore: true)
  $PleromaApiListRepliesPolicyTypeCopyWith<PleromaApiListRepliesPolicyType>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PleromaApiListRepliesPolicyTypeCopyWith<$Res> {
  factory $PleromaApiListRepliesPolicyTypeCopyWith(
          PleromaApiListRepliesPolicyType value,
          $Res Function(PleromaApiListRepliesPolicyType) then) =
      _$PleromaApiListRepliesPolicyTypeCopyWithImpl<$Res,
...
/// @nodoc
class _$PleromaApiListRepliesPolicyTypeCopyWithImpl<$Res,
        $Val extends PleromaApiListRepliesPolicyType>
    implements $PleromaApiListRepliesPolicyTypeCopyWith<$Res> {
  _$PleromaApiListRepliesPolicyTypeCopyWithImpl(this._value, this._then);
...
class __$$FollowedImplCopyWithImpl<$Res>
    extends _$PleromaApiListRepliesPolicyTypeCopyWithImpl<$Res, _$FollowedImpl>
...
class _$FollowedImpl implements _Followed {
  const _$FollowedImpl(
      {this.stringValue = PleromaApiListRepliesPolicyType.followedStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiListRepliesPolicyType.followed(stringValue: $stringValue)';
  }
...
abstract class _Followed implements PleromaApiListRepliesPolicyType {
...
class __$$ListImplCopyWithImpl<$Res>
    extends _$PleromaApiListRepliesPolicyTypeCopyWithImpl<$Res, _$ListImpl>
...
class _$ListImpl implements _List {
  const _$ListImpl(
      {this.stringValue = PleromaApiListRepliesPolicyType.listStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiListRepliesPolicyType.list(stringValue: $stringValue)';
  }
...
abstract class _List implements PleromaApiListRepliesPolicyType {
...
class __$$NoneImplCopyWithImpl<$Res>
    extends _$PleromaApiListRepliesPolicyTypeCopyWithImpl<$Res, _$NoneImpl>
...
class _$NoneImpl implements _None {
  const _$NoneImpl(
      {this.stringValue = PleromaApiListRepliesPolicyType.noneStringValue});
  ...
  @override
  String toString() {
    return 'PleromaApiListRepliesPolicyType.none(stringValue: $stringValue)';
  }
...
abstract class _None implements PleromaApiListRepliesPolicyType {
...
class __$$UnknownImplCopyWithImpl<$Res>
    extends _$PleromaApiListRepliesPolicyTypeCopyWithImpl<$Res, _$UnknownImpl>
...
class _$UnknownImpl implements _Unknown {
  ...
  @override
  String toString() {
    return 'PleromaApiListRepliesPolicyType.unknown(stringValue: $stringValue)';
  }
...
abstract class _Unknown implements PleromaApiListRepliesPolicyType {
