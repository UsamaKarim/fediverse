...
class PleromaApiScheduledStatusParamsAdapter
    extends TypeAdapter<PleromaApiScheduledStatusParams> {
  @override
  final int typeId = 0;

  @override
  PleromaApiScheduledStatusParams read(BinaryReader reader) {
    ...
    return PleromaApiScheduledStatusParams(
      ...
      poll: fields[8] as PleromaApiPostStatusPoll?,
  ...
  @override
  void write(BinaryWriter writer, PleromaApiScheduledStatusParams obj) {
    writer
      ..writeByte(12)
      ..writeByte(13)
      ..write(obj.to)
  ...
  bool operator ==(Object other) =>
      ...
      other is PleromaApiScheduledStatusParamsAdapter &&
