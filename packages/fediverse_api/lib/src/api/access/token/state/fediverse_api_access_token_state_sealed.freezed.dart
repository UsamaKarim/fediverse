...
part of 'fediverse_api_access_token_state_sealed.dart';
...
/// @nodoc
mixin _$FediverseApiAccessTokenState<TToken extends IFediverseApiAccessToken> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $FediverseApiAccessTokenStateCopyWith<
    TToken extends IFediverseApiAccessToken, $Res> {
  factory $FediverseApiAccessTokenStateCopyWith(
          FediverseApiAccessTokenState<TToken> value,
          $Res Function(FediverseApiAccessTokenState<TToken>) then) =
      _$FediverseApiAccessTokenStateCopyWithImpl<TToken, $Res,
          FediverseApiAccessTokenState<TToken>>;
}

/// @nodoc
class _$FediverseApiAccessTokenStateCopyWithImpl<
        TToken extends IFediverseApiAccessToken,
        $Res,
        $Val extends FediverseApiAccessTokenState<TToken>>
    implements $FediverseApiAccessTokenStateCopyWith<TToken, $Res> {
  _$FediverseApiAccessTokenStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$NotExistImplCopyWith<TToken extends IFediverseApiAccessToken,
    $Res> {
...
/// @nodoc
class __$$NotExistImplCopyWithImpl<TToken extends IFediverseApiAccessToken,
        $Res>
    extends _$FediverseApiAccessTokenStateCopyWithImpl<TToken, $Res,
...
class _$NotExistImpl<TToken extends IFediverseApiAccessToken>
    implements _NotExist<TToken> {
  const _$NotExistImpl();

  @override
  String toString() {
    return 'FediverseApiAccessTokenState<$TToken>.notExist()';
  }
...
abstract class _NotExist<TToken extends IFediverseApiAccessToken>
    implements FediverseApiAccessTokenState<TToken> {
  const factory _NotExist() = _$NotExistImpl<TToken>;
}

/// @nodoc
abstract class _$$ValidImplCopyWith<TToken extends IFediverseApiAccessToken,
    $Res> {
...
/// @nodoc
class __$$ValidImplCopyWithImpl<TToken extends IFediverseApiAccessToken, $Res>
    extends _$FediverseApiAccessTokenStateCopyWithImpl<TToken, $Res,
...
class _$ValidImpl<TToken extends IFediverseApiAccessToken>
  ...
  @override
  String toString() {
    return 'FediverseApiAccessTokenState<$TToken>.valid(token: $token)';
  }
...
abstract class _Valid<TToken extends IFediverseApiAccessToken>
    implements FediverseApiAccessTokenState<TToken> {
...
/// @nodoc
abstract class _$$ErrorImplCopyWith<TToken extends IFediverseApiAccessToken,
    $Res> {
...
/// @nodoc
class __$$ErrorImplCopyWithImpl<TToken extends IFediverseApiAccessToken, $Res>
    extends _$FediverseApiAccessTokenStateCopyWithImpl<TToken, $Res,
...
class _$ErrorImpl<TToken extends IFediverseApiAccessToken>
    implements _Error<TToken> {
  const _$ErrorImpl();

  @override
  String toString() {
    return 'FediverseApiAccessTokenState<$TToken>.error()';
  }
...
abstract class _Error<TToken extends IFediverseApiAccessToken>
    implements FediverseApiAccessTokenState<TToken> {
